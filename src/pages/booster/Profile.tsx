...
import BoosterProfileTab from "../../components/booster/BoosterProfileTab";
import NotificationTab from "../../components/pioneer/NotificationTab";
import PasswordTab from "../../components/pioneer/PasswordTab";
import BoosterVerifyTab from "../../components/booster/BoosterVerifyTab";
...
const Profile = () => {
  ...
  return (
    <div className="max-w-[670px] mx-auto">
      ...
      {/* Tab Content */}
      {activeTab === "profile"      && <BoosterProfileTab />}
      {activeTab === "notification" && <NotificationTab />}
      {activeTab === "password"     && <PasswordTab />}
      {activeTab === "verify"       && <BoosterVerifyTab />}
    </div>
  );
};
