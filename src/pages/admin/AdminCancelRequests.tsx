    ...
    return (
        <div className="flex flex-col gap-[16px]">
            ...
            <div className="bg-white rounded-xl border border-border overflow-hidden text-[14px]">
                <div className="grid grid-cols-[44px_minmax(0,1fr)_90px_96px] xl:grid-cols-[60px_2fr_1fr_2fr_120px_120px] bg-surface-table px-2 xl:px-4 py-3 font-medium text-gray-500 border-b border-border text-[12px] xl:text-[13px]">
                    <div className="text-center">ลำดับ</div>
                    <div>โปรเจกต์</div>
                    <div className="text-center">เจ้าของโปรเจกต์</div>
                    <div className="hidden xl:block">เหตุผล</div>
                    ...
                    filtered.map((r, index) => {
                        ...
                        return (
                            <div
                                ...
                                className="grid grid-cols-[44px_minmax(0,1fr)_90px_96px] xl:grid-cols-[60px_2fr_1fr_2fr_120px_120px] px-2 xl:px-4 border-b border-border last:border-0 hover:bg-gray-50 transition-colors cursor-pointer"
                            >
                                ...
                                <div className="h-14 min-w-0 flex flex-col justify-center px-1 xl:px-2">
                                    ...
                                    <span className="hidden xl:block text-[11px] text-muted-foreground">{fmtDate(r.UpdatedAt)}</span>
                                </div>
                                ...
                                <div className="hidden xl:flex h-14 items-center px-2">
